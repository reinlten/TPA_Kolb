file = open("Messdaten/step4.txt", "r")
data = file.readlines()
...
# TODO WERDEN EVTL NICHT GEBRAUCHT; ZEROLINE DIREKT BERECHNEN --> ÜBERHAUPT BERECHNEN??
max1 = []
max2 = []
min1 = []
min2 = []
...
# print(index_max1)
# TODO: calculate zero-line by averaging max and mins of both signals in one period.
...
if len(signal_zero1) == len(signal_zero2):
    ...
    print("phase shift:")
    print(sum(phase_array) / len(phase_array))
